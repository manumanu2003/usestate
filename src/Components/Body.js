...
import Image from '../Components/images/maldives.jpeg'
...
const Body = () => {
    ...
    return (
        <div>
            ...
            <div style={{ paddingTop: '50px', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column',marginBottom:'200px' }}>
